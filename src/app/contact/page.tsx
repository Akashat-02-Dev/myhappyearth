  ...
  return (
    <>
      <div className="absolute top-0 w-full z-50">
        {/* Pass isLockedDark dynamically based on the FAQ view.
            Pass your original invert logic for the standard form view. */}
        <Navbar invert={!isFAQView} isLockedDark={isFAQView} />
      </div>
      ...
      {isFAQView ? (
        <div className="w-full flex-grow pt-36 pb-12 bg-earth-light flex flex-col items-center">
          ...
          {/* A sleek toggle to let users easily switch back to the contact form */}
