...
export default function TimelineSection() {
  return (
    <div className="w-full bg-earth-light text-earth-deep py-20 md:py-32 border-t-4 md:border-t-8 border-earth-sage/20 relative z-10">
      <div className="max-w-[100rem] mx-auto">
        ...
        <div className="block lg:hidden px-6 sm:px-12 py-8 relative">
          {/* Vertical Connecting Line */}
          <div className="absolute left-[3.25rem] sm:left-[4.75rem] top-8 bottom-8 w-1 bg-earth-forest z-0"></div>
          
          <div className="flex flex-col gap-10 relative z-10">
            {timelineData.map((node, index) => (
              <div key={index} className="flex items-start gap-6 sm:gap-8 w-full group">
                {/* Icon */}
